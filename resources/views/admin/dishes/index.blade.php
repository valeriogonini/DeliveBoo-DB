...
@section('content')
    ...
    <div class="container">
        <div class="d-flex justify-content-between pt-3">
            ...
            <a class="btn btn-secondary me-2" href="{{ route('admin.restaurants.show', $restaurant) }}">Indietro</a>
                        ...
                        @foreach ($restaurant->dishes as $dish)
                            <div class="col-sm-4">
                                <div class="card mb-2 p-3" style=" height:550px">
                                    ...
                                    <a class="btn btn-bg ms_btn me-4"
                                        href="{{ route('admin.dishes.show', $dish) }}">Dettagli piatto</a>
                                </div>
                            </div>
                        @endforeach
                    @endif
